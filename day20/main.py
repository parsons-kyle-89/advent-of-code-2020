...
import os.path
from typing import cast, Iterator, List, NoReturn, Optional, Tuple, TypeVar
...
class Tile:
    ...
    def flip(self, flip: Flip) -> "Tile":
        if flip is Flip.ID:
            ...
            return Tile(
                self.tile_id,
                border_a=''.join(reversed(self.border_a)),
                border_b=''.join(reversed(self.border_d)),
                border_c=''.join(reversed(self.border_c)),
                border_d=''.join(reversed(self.border_b)),
            )
    ...
    def matches(self, other: "Tile", direction: Direction) -> bool:
        if direction is Direction.ABOVE:
            return self.border_a == other.border_c
        elif direction is Direction.RIGHT:
            return self.border_b == other.border_d
        elif direction is Direction.BELOW:
            return self.border_c == other.border_a
        elif direction is Direction.LEFT:
            return self.border_d == other.border_b
